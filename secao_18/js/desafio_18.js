(function () {
    ...
    */
    ...
    cpfs.forEach(function(item, index, arr) {
    ...
    */
    ...
    let regexJu = /ju[nl]ho/g;
    let textoJu = "Os meses de janeiro, junho e julho começam com a letra j.";
    console.log(textoJu.match(regexJu));
    ...
    */
    ...
    console.log(
        "<div><section><blockquote>Texto <img /></blockquote></section></div>".match(/<(\w)+>/g)
    );
    ...
    */
    ...
    console.log(
        "<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(/<(\w)+><\/(\w)+>/g)
    );
    ...
    */
    ...
    let regexTag = /<(\w+)>([^<]+)<\/\w+>/g;
    let textoHtml = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
    console.log(
        textoHtml.replace(
            regexTag, 
