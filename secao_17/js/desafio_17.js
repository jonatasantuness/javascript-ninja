(function () {
    ...
    */
    ...
    console.log(texto.replace(/(Manuel Marques de Sousa)/, 'Jonatas Souza'));
    ...
    */
    ...
    console.log(texto.replace(/(brasileiro)/, 'paulista'));
    ...
    */
    ...
    console.log(texto.replace(/[D-Za-h]/g, 0));
    ...
    */
    ...
    console.log(texto.replace(/O Centauro de Luvas/g, function(frase) {
    ...
    */
    ...
    console.log(texto.replace(regexDate, replaceDate));
